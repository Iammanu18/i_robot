...
setInterval(() => {
    ...
    dx = parseInt(window.getComputedStyle(robo, null).getPropertyValue('left'));// give value of robo in left
    dy = parseInt(window.getComputedStyle(robo, null).getPropertyValue('top'));

    ox = parseInt(window.getComputedStyle(obstacle, null).getPropertyValue('left'));
    oy = parseInt(window.getComputedStyle(obstacle, null).getPropertyValue('top'));

    offsetX = Math.abs(dx - ox); //give absolute value
